...
/*!
 * @brief Set FLEXCAN compatible mode.
 */
typedef enum
{
    SYSCFG_FLEXCANMode_STOP = 16u, /*!< FLEXCAN enter in debug mode. */
    SYSCFG_FLEXCANMode_TEST = 17u, /*!< FEXCAN enter in test mode. */
    SYSCFG_FLEXCANMode_SPV = 18,   /*!< FEXCAN enter in Monitoring mode. */
} SYSCFG_FLEXCANMode_Type;
...
typedef enum
{
    ...
    SYSCFG_EXTIPort_GPIOH = (0x07U), /*!< SYSCFG External Interrupt GPIOH. */
    SYSCFG_EXTIPort_GPIOI = (0x08U), /*!< SYSCFG External Interrupt GPIOI. */
 ...
 *
 * @param mode FMSC pin use mode to be set. See to @ref SYSCFG_FLEXCANMode_Type.
 * @return None.
 */
